...
function createParcel(parcel, callback) {
  ...
  stmt.run(tracking_id, parcel.customer_name, parcel.delivery_address, parcel.contact_number, parcel.size, parcel.weight, (err) => {
...
module.exports = { createParcel, getAllParcels, getParcelById }; */

const db = require("../Models/parcelModel.js");
const { v4: uuidv4 } = require("uuid");
